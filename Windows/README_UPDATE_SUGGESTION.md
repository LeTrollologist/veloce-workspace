...
> Lightweight Windows-native node orchestration and private networking
...
[![Tauri](https://img.shields.io/badge/Tauri-2-black?style=flat-square&logo=tauri)
...
### net_demo — Full VeloceNet Pipeline
Demonstrates connecting to VeloceCore, spawning a node, registering a `.vln` hostname, and making HTTP requests through the SOCKS5 proxy.

```powershell
# Terminal 1: Run VeloceCore
